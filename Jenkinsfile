pipeline {
 ...
 post {      
     success {
            slackSend (baseUrl: "https://northeasternuhq.slack.com/services/hooks/jenkins-ci//", token: "FxNFkRxN2MlzjDED5wv2twCS", channel: "#team-2", color: '#00FF00', message: "SUCCESSFUL: Job '${env.JOB_NAME}")
            }
   failure {  
         slackSend (baseUrl: "https://northeasternuhq.slack.com/services/hooks/jenkins-ci/", token: "FxNFkRxN2MlzjDED5wv2twCS", channel: "#team-2", color: '#FF0000', message: "FAILED: Job '${env.JOB_NAME}")
         }
   }
} //pipeline
